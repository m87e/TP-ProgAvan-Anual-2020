...
public interface IClienteDAO {
	...
	void ModificarCliente(Cliente cliente) throws IOException, ParseException, ClassNotFoundException;

	void EliminarCliente(Cliente cliente) throws IOException, ParseException;

	List<Cliente> GetAll() throws IOException, ParseException, ClassNotFoundException;
