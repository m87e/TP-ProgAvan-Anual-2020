...
public class VuelosABM_view extends JPanel implements ActionListener{
	...
	public VuelosABM_view() {
		
		SpringLayout springLayout = new SpringLayout();
		setLayout(springLayout);
		
		JLabel lblVuelos = new JLabel("Vuelos");
		lblVuelos.setFont(new Font("Lucida Sans", Font.BOLD, 40));
		springLayout.putConstraint(SpringLayout.NORTH, lblVuelos, 10, SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.WEST, lblVuelos, 10, SpringLayout.WEST, this);
		add(lblVuelos);
		
		JScrollPane scrollPane = new JScrollPane();
		springLayout.putConstraint(SpringLayout.NORTH, scrollPane, 17, SpringLayout.SOUTH, lblVuelos);
		...
		springLayout.putConstraint(SpringLayout.WEST, panel_7, 634, SpringLayout.WEST, this);
		...
		springLayout.putConstraint(SpringLayout.SOUTH, panel_8, -231, SpringLayout.SOUTH, this);
		springLayout.putConstraint(SpringLayout.NORTH, panel_1, 6, SpringLayout.SOUTH, panel_8);
		springLayout.putConstraint(SpringLayout.SOUTH, scrollPane, -9, SpringLayout.NORTH, panel_8);
		springLayout.putConstraint(SpringLayout.NORTH, panel_8, 291, SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.WEST, panel_8, 24, SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.EAST, panel_8, -10, SpringLayout.EAST, this);
		add(panel_8);
