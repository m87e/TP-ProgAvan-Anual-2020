...
public class ClientesAltaView extends JPanel{
	...
	private JButton btn_Guardar,btnCancelar,btn_GoConsultaCliente;
	...
	public ClientesAltaView() {
		...
		sl_panel_botones.putConstraint(SpringLayout.NORTH, btn_Guardar, 218, SpringLayout.NORTH, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.WEST, btn_Guardar, 22, SpringLayout.WEST, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.SOUTH, btn_Guardar, -10, SpringLayout.SOUTH, panel_botones);
		...
		sl_panel_botones.putConstraint(SpringLayout.NORTH, btnCancelar, 218, SpringLayout.NORTH, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.SOUTH, btnCancelar, -10, SpringLayout.SOUTH, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.EAST, btn_Guardar, -6, SpringLayout.WEST, btnCancelar);
		sl_panel_botones.putConstraint(SpringLayout.WEST, btnCancelar, 152, SpringLayout.WEST, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.EAST, btnCancelar, -33, SpringLayout.EAST, panel_botones);
		...
		btn_GoConsultaCliente = new JButton("Consulta de Clientes");
		btn_GoConsultaCliente.setFont(new Font("Lucida Sans", Font.PLAIN, 13));
		sl_panel_botones.putConstraint(SpringLayout.NORTH, btn_GoConsultaCliente, 162, SpringLayout.NORTH, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.WEST, btn_GoConsultaCliente, 0, SpringLayout.WEST, btn_Guardar);
		sl_panel_botones.putConstraint(SpringLayout.SOUTH, btn_GoConsultaCliente, -6, SpringLayout.NORTH, btn_Guardar);
		sl_panel_botones.putConstraint(SpringLayout.EAST, btn_GoConsultaCliente, 0, SpringLayout.EAST, btnCancelar);
		panel_botones.add(btn_GoConsultaCliente);
		
		lblMensajeExito = new JLabel("El cliente se creado exitosamente!");
		lblMensajeExito.setEnabled(false);
		lblMensajeExito.setVisible(false);
		
		sl_panel_botones.putConstraint(SpringLayout.NORTH, lblMensajeExito, 25, SpringLayout.NORTH, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.WEST, lblMensajeExito, 22, SpringLayout.WEST, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.SOUTH, lblMensajeExito, 80, SpringLayout.NORTH, panel_botones);
		sl_panel_botones.putConstraint(SpringLayout.EAST, lblMensajeExito, 0, SpringLayout.EAST, btnCancelar);
		lblMensajeExito.setForeground(new Color(60, 179, 113));
		lblMensajeExito.setFont(new Font("Lucida Sans", Font.BOLD, 13));
		panel_botones.add(lblMensajeExito);
		
		lblMensajeCancelado = new JLabel("Operacion Cancelada");
		lblMensajeCancelado.setEnabled(false);
		lblMensajeCancelado.setVisible(false);
		
		sl_panel_botones.putConstraint(SpringLayout.NORTH, lblMensajeCancelado, 6, SpringLayout.SOUTH, lblMensajeExito);
		sl_panel_botones.putConstraint(SpringLayout.WEST, lblMensajeCancelado, 0, SpringLayout.WEST, btn_Guardar);
		sl_panel_botones.putConstraint(SpringLayout.SOUTH, lblMensajeCancelado, 56, SpringLayout.SOUTH, lblMensajeExito);
		sl_panel_botones.putConstraint(SpringLayout.EAST, lblMensajeCancelado, 0, SpringLayout.EAST, btnCancelar);
		lblMensajeCancelado.setForeground(new Color(220, 20, 60));
		lblMensajeCancelado.setFont(new Font("Lucida Sans", Font.BOLD, 13));
		panel_botones.add(lblMensajeCancelado);
		getBtn_GoConsultaCliente().addActionListener(new ClienteAltaEvents(this));
	...
	public JButton getBtn_GoConsultaCliente() {
		return btn_GoConsultaCliente;
	}

	public void setBtn_GoConsultaCliente(JButton btn_GoConsultaCliente) {
		this.btn_GoConsultaCliente = btn_GoConsultaCliente;
	}
